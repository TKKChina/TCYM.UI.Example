                ...
                new UIMenu
                {
                    ...
                    Items = new List<MenuItem>
                    {
                        ...
                        MenuItem.Group("group-data-entry", "数据录入", new List<MenuItem>
                        {
                            ...
                            new("switch", "开关") { Icon = "&#xed5f;" },
                            new("input", "输入框") { Icon = "&#xe790;" },
                            new("codeEditor", "代码编辑器") { Icon = "&#xe61d;", Badge = new UIBadge { CountText = "NEW",ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#34f50d")} },
                        }),
                        MenuItem.Group("group-data-display", "数据展示", new List<MenuItem>
                        {
                            MenuItem.Divider("group-data-display-divider-top"),
                            new("badge", "徽标数") { Icon = "&#xe61c;" },
                            new("image", "图片") { Icon = "&#xe60d;", Badge = new UIBadge { CountText = "NEW",ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#34f50d")} },
                            new("virtualScrollView", "虚拟滚动") { Icon = "&#xe610;", Badge = new UIBadge { CountText = "NEW",ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#34f50d")} },
                        ...
                        MenuItem.Group("group-other", "其他", new List<MenuItem>
                        {
                            ...
                            new("filePicker", "文件选择") { Icon = "&#xea3e;", Badge = new UIBadge { CountText = "NEW",ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#34f50d")} },
                            new("usbCamera", "USB 摄像头") { Icon = "&#xe965;", Badge = new UIBadge { CountText = "NEW",ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#34f50d")} },
                        })
                    },
                    OnSelect = (keys, item) =>
                    {
