                ...
                new UIMenu
                {
                    ...
                    Items = new List<MenuItem>
                    {
                        MenuItem.Group("group-universal", "通用", new List<MenuItem>
                        {
                            ...
                            new("label", "文本") { Icon = "&#xe651;"},
                            new("glass", "CSS") { Icon = "&#xe6d5;", Badge = new UIBadge { CountText = "更新", ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#28b5ec") } },
                        }),
                        ...
                        MenuItem.Group("group-data-entry", "数据录入", new List<MenuItem>
                        {
                            ...
                            new("slider", "滑动条") { Icon = "&#xe6d1;" },
                            new("select", "选择器") { Icon = "&#xe70b;" },
                            new("treeSelect", "树选择器") { Icon = "&#xe67b;", Badge = new UIBadge { CountText = "更新", ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#28b5ec") } },
                            new("checkbox", "多选框") { Icon = "&#xe66d;" },
                            new("radio", "单选框") { Icon = "&#xe71f;" },
                            new("datepicker", "日期选择框") { Icon = "&#xe629;" },
                            new("timePicker", "时间选择框") { Icon = "&#xe7ec;" },
                            ...
                            new("binding", "Binding") { Icon = "&#xe61d;", Badge = new UIBadge { CountText = "NEW", ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#34f50d") } },
                        ...
                        MenuItem.Group("group-feedback", "反馈", new List<MenuItem>
                        {
                            ...
                            new("message", "消息") { Icon = "&#xe671;" },
                            new("notification", "通知提醒") { Icon = "&#xe671;", Badge = new UIBadge { CountText = "更新", ShowOutline = false, BadgeColor = ColorHelper.ParseColor("#28b5ec") }  },
                            new("modal", "对话框") { Icon = "&#xe6ad;" },
